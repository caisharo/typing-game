...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TypingGame", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TypingGame", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "TypingGame";
		app.meta["name"] = "TypingGame";
